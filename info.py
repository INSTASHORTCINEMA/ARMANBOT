...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','ARMAN_PRO_BOY') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','ARMAN_PRO_BOY') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','INSTASHORTCINEMA')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+IZRtADt3oXAwZGY1") #[ without @ ]
